...
export default function HomePageLit() {
    return (
        <div className="paragraphAfterBannerSpacing homeLitParagraph">
            <Container fluid>
                <Row>
                    <Col xs={12}>
                        ...
                        <p className="homePage-p">Leitrim Pride envisions a unified community where diverse individuals are celebrated and are able to thrive as their authentic selves.</p>
                    </Col>
                </Row>
            </Container>
        </div>
