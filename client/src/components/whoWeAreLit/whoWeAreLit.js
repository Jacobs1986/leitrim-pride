...
export default function WhoWeAreLit() {
    return (
        <div className='whoWeAreTextCol'>
            ...
            <p>Leitrim Pride has been developed organically through the coming together of members of Leitrim LGBTQI+ community forming a Steering Committee in early 2021 and organising Leitrim’s inaugural Pride Festival to generate visibility</p>
